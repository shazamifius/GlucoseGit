...
pub fn layout_organize_panel(
    ...
    let layout_options_def = [
        (
            LayoutMode::Compact,
            "Rangées compactes",
            "Respecte les ratios, remplit chaque ligne",
        ),
        (
            LayoutMode::Masonry,
            "Masonry (colonnes)",
            "Colonnes indépendantes — Pinterest",
        ),
        (
            LayoutMode::Grid,
            "Grille alignée",
            "Même largeur par colonne, ratios conservés",
        ),
        (
        ...
        (
            LayoutMode::BySlot,
            "Par slot preset",
            "Colonnes séparées par catégorie",
        ),
    ];
...
pub fn layout_plugins_panel(px: f32, py: f32, pw: f32, _ph: f32, scale: f32) -> PluginsPanelLayout {
    let s = crate::theme::clamp_ui_scale(scale);
    let pad_x = 14.0 * s;
    ...
    for i in 0..3 {
        density_options.push(WidgetRect::new(
            px + pad_x,
            dens_y + i as f32 * 16.0 * s,
            pw - 28.0 * s,
            16.0 * s,
        ));
    }
    ...
    for i in 0..2 {
        disposition_options.push(WidgetRect::new(
            px + pad_x,
            disp_y + i as f32 * 16.0 * s,
            pw - 28.0 * s,
            16.0 * s,
        ));
    }
...
pub fn render_docks(
    ...
    for b in &layouts {
        ...
        draw_grip_dots(
            pixmap,
            px + pw / 2.0,
            gy + b.grip_height / 2.0,
            b.is_dragged || is_grip_hover,
            theme,
            s,
        );
...
fn render_organize_content(
    ...
    push_rounded_rect(
        &mut tpb,
        layout.target_count_rect.x,
        layout.target_count_rect.y,
        layout.target_count_rect.w,
        layout.target_count_rect.h,
        3.0 * s,
    );
    ...
    typo.draw_text(
        pixmap,
        "LARGEUR CIBLE",
        layout.target_size_rect.x,
        layout.target_size_rect.y - 12.0 * s,
        TextStyle {
            size: 9.0 * s,
            color: theme.text_muted,
            bold: true,
    ...
    push_rounded_rect(
        &mut in_pb,
        layout.target_size_rect.x,
        layout.target_size_rect.y,
        layout.target_size_rect.w,
        layout.target_size_rect.h,
        3.0 * s,
    );
    push_rounded_rect(
        &mut in_pb,
    ...
    typo.draw_text(
        ...
        layout.target_size_rect.x + 8.0 * s,
        layout.target_size_rect.y + 4.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    typo.draw_text(
        ...
        layout.gap_rect.x + 8.0 * s,
        layout.gap_rect.y + 4.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    btn_p.set_color(if is_apply_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    typo.draw_text(
        pixmap,
        "Appliquer",
        layout.apply_rect.x + (layout.apply_rect.w - aw) / 2.0,
        layout.apply_rect.y + 6.5 * s,
        TextStyle {
            size: 12.0 * s,
            color: theme.text_primary,
            bold: true,
...
fn render_pomodoro_content(
    ...
    p_start.set_color(if is_start_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    push_rounded_rect(
        ...
        layout.start_button.w,
        layout.start_button.h,
        4.0 * s,
    );
    ...
    typo.draw_text(
        pixmap,
        btn_txt,
        layout.start_button.x + (layout.start_button.w - btw) / 2.0,
        layout.start_button.y + 5.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    p_reset.set_color(if is_reset_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    push_rounded_rect(
        &mut pb_reset,
        layout.reset_button.x,
        layout.reset_button.y,
        layout.reset_button.w,
        layout.reset_button.h,
        4.0 * s,
    );
    ...
    typo.draw_text(
        pixmap,
        "↺",
        layout.reset_button.x + (layout.reset_button.w - rw) / 2.0,
        layout.reset_button.y + 4.0 * s,
        TextStyle {
            size: 12.0 * s,
            color: theme.text_muted,
            bold: false,
...
fn render_storyboard_content(
    ...
    f_paint.set_color(if is_fmt_hover {
        theme.bg_hover
    } else {
        theme.input_bg
    });
    ...
    push_rounded_rect(
        &mut fpb,
        layout.format_button.x,
        layout.format_button.y,
        layout.format_button.w,
        layout.format_button.h,
        4.0 * s,
    );
    ...
    typo.draw_text(
        pixmap,
        fmt_str,
        layout.format_button.x + 8.0 * s,
        layout.format_button.y + 6.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        "˅",
        layout.format_button.x + layout.format_button.w - 16.0 * s,
        layout.format_button.y + 4.0 * s,
        TextStyle {
            size: 12.0 * s,
            color: theme.text_muted,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        "LARGEUR",
        layout.width_input.x,
        layout.width_input.y - 12.0 * s,
        TextStyle {
            size: 9.0 * s,
            color: theme.text_muted,
            bold: true,
    ...
    typo.draw_text(
        ...
        layout.width_input.x + 8.0 * s,
        layout.width_input.y + 4.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        &format!("{}", state.cols),
        layout.cols_input.x + 8.0 * s,
        layout.cols_input.y + 4.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        &format!("{}", state.gap as i32),
        layout.gap_input.x + 8.0 * s,
        layout.gap_input.y + 4.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    act_p.set_color(if state.active {
        theme.bg_active
    } else if is_act_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    push_rounded_rect(
        &mut act_pb,
        layout.activate_button.x,
        layout.activate_button.y,
        layout.activate_button.w,
        layout.activate_button.h,
        4.0 * s,
    );
    ...
    typo.draw_text(
        pixmap,
        btn_lbl,
        layout.activate_button.x + (layout.activate_button.w - bw) / 2.0,
        layout.activate_button.y + 7.5 * s,
        TextStyle {
            size: 12.0 * s,
            color: theme.text_primary,
            bold: true,
...
fn render_plugins_content(
    ...
    typo.draw_text(
        pixmap,
        "Détection de la machine : à venir",
        px + 14.0 * s,
        py + 68.0 * s,
        TextStyle {
            size: 10.0 * s,
    ...
    let after_label = typo.draw_text(
        pixmap,
        "Modèle conseillé pour ce PC : ",
        px + 14.0 * s,
        py + 82.0 * s,
        TextStyle {
            size: 10.5 * s,
    ...
    down_p.set_color(if is_down_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    push_rounded_rect(
        &mut dpb2,
        layout.download_button.x,
        layout.download_button.y,
        layout.download_button.w,
        layout.download_button.h,
        4.0 * s,
    );
    ...
    typo.draw_text(
        ...
        layout.download_button.x + (layout.download_button.w - dtw) / 2.0,
        layout.download_button.y + 6.0 * s,
        TextStyle {
            size: 11.0 * s,
            color: theme.text_primary,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        "Cours magistral (intégré)",
        layout.card_rect.x + 8.0 * s,
        layout.card_rect.y + 8.0 * s,
        TextStyle {
            size: 11.5 * s,
            color: theme.text_primary,
            bold: true,
    ...
    typo.draw_text(
        pixmap,
        "Transforme un texte en carte de concepts avec l'IA",
        layout.card_rect.x + 8.0 * s,
        layout.card_rect.y + 23.0 * s,
        TextStyle {
            size: 9.5 * s,
            color: theme.text_secondary,
            bold: false,
    ...
    typo.draw_text(
        pixmap,
        "locale. Aucun binaire à installer. v1.0",
        layout.card_rect.x + 8.0 * s,
        layout.card_rect.y + 35.0 * s,
        TextStyle {
            size: 9.5 * s,
            color: theme.text_muted,
            bold: false,
    ...
    typo.draw_text(
        ...
        "RÉGLAGES",
        px + 14.0 * s,
        layout.card_rect.y + layout.card_rect.h + 16.0 * s,
        TextStyle {
            size: 9.5 * s,
            color: theme.text_muted,
            bold: true,
    ...
    typo.draw_text(
        ...
        "Densité",
        px + 14.0 * s,
        layout.density_options[0].y - 14.0 * s,
        TextStyle {
            size: 10.5 * s,
            color: theme.text_secondary,
            bold: true,
    ...
    typo.draw_text(
        ...
        "Disposition",
        px + 14.0 * s,
        layout.disposition_options[0].y - 14.0 * s,
        TextStyle {
            size: 10.5 * s,
            color: theme.text_secondary,
            bold: true,
...
fn render_preset_content(
    ...
    custom_p.set_color(if is_custom_hover {
        theme.bg_hover
    } else {
        theme.btn_bg
    });
    ...
    typo.draw_text(
        ...
        custom_rect.x + (custom_rect.w - ctw) / 2.0,
        custom_rect.y + 6.0 * s,
        TextStyle {
            size: 10.5 * s,
            color: theme.text_secondary,
...
pub fn apply_organize_layout(images: &[BoardImage], state: &OrganizeState) -> Vec<LayoutResult> {
    ...
    let results = glucose_core::layout::calculate_image_layout(
...
mod tests {
    ...
    fn test_organize_layout_exact_utf8_hit_test() {
        ...
        let panel_layout = layout_organize_panel(
            org_box.x,
            org_box.y,
            org_box.width,
            org_box.height,
        ...
        let lum_asc_btn = panel_layout
            .sort_buttons
            .iter()
            .find(|b| b.sort_type == SortType::LumAsc)
            .unwrap();
        ...
        let org_box_hi = layouts_hi
            .iter()
            .find(|b| b.tab == TabId::Organize)
            .unwrap();
        assert_eq!(org_box_hi.width, TabId::Organize.default_width() * 1.5);

        let panel_layout_hi = layout_organize_panel(
            org_box_hi.x,
            org_box_hi.y,
            org_box_hi.width,
            org_box_hi.height,
        ...
        let lum_desc_btn = panel_layout_hi
            .sort_buttons
            .iter()
            .find(|b| b.sort_type == SortType::LumDesc)
            .unwrap();
        let click_x_hi = lum_desc_btn.rect.x + lum_desc_btn.rect.w / 2.0;
        let click_y_hi = lum_desc_btn.rect.y + lum_desc_btn.rect.h / 2.0;

        let screen_hi = ScreenFrame {
            width: 1440.0,
            height: 900.0,
            header_h: 78.0 * 1.5,
            scale: 1.5,
        };
        let res_hi = handle_dock_click(
            &mut dock_hi,
            &store,
            &typo,
            screen_hi,
