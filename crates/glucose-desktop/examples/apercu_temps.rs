    ...
    TempsUi {
        ...
        jalons: vec![
            JalonVu {
                ...
                date: glucose_desktop::plateforme::heure::heure_locale(maintenant - 4_200_000),
            },
            JalonVu {
                apres: 17,
                ...
                date: glucose_desktop::plateforme::heure::heure_locale(maintenant - 2_500_000),
            },
            JalonVu {
                apres: 35,
                libelle: String::new(),
                ...
                date: glucose_desktop::plateforme::heure::heure_locale(maintenant - 600_000),
            },
        ],
        regarde,
