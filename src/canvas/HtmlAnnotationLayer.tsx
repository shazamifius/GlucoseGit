...
// `getSymbioticHue` vit désormais dans utils/symbioticHue.ts (fonction pure).
// On la re-exporte ici pour ne pas casser les imports existants.
export { getSymbioticHue };
