...
interface Props {
  /** Ferme le panneau une fois son action accomplie (preset choisi). Ce n'est
   *  PAS un bouton de fermeture : la fermeture manuelle passe par la poignée. */
  onClose: () => void;
  /** Rendu en tiroir dans le dock : le dock fournit le positionnement. */
  docked?: boolean;
}

export default function PresetPanel({ onClose, docked }: Props) {
